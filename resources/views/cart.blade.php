@section('content')
  ...
  -webkit-box-shadow: inset 0 0 0.7px rgba(0, 0, 0, 0.2); /* Légère ombre */
  border-radius: 10px;
...
.scrollbar-custom-style::-webkit-scrollbar-thumb {
  border-radius: 10px;
  -webkit-box-shadow: inset 0 0 0.7px rgba(0, 0, 0, 0.2); /* Légère ombre */
  background-color:  rgb(226 232 240); /* Utilisation de la couleur #F43F5E */
}
    </style>
    <div class="container mx-auto mt-10">
        <div class="flex  my-10 p-8 gap-5">
            <div
                class="scrollbar-custom-style w-3/4 bg-slate-50 max-h-[40rem] px-10 py-10 rounded-lg border-2 overflow-x-hidden border-slate-300">
                ...
                <div class="flex items-center rounded-md border-2 hover:bg-gray-100 mx-1.5 my-5 px-6 py-5">
                    <div class="flex w-2/5"> <!-- product -->
                        ...
                        <div class="flex flex-col justify-between ml-4 ">
                            <span class="font-bold text-sm font-roboto text-slate-900">Iphone 6S</span>
                            <span
                                class="text-slate-900 font-medium text-xs text-center rounded-full bg-amber-500 py-0.5 px-1">Apple</span>
                            <span class="text-lg font-semibold text-rose-500 font-readex">199 DH</span>
                        </div>
                    </div>
                    ...
                    <span class="text-center w-2/5 text-xl font-semibold text-rose-500 font-readex">499 DH</span>
                    <div>
                        <button class="inline-block p-3 text-gray-700 hover:text-rose-600 focus:relative"
