            ...
            <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex items-baseline justify-between border-b border-gray-200 pt-24 pb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="Search" placeholder="Search for..."
                            class="w-80 rounded-lg border font-roboto border-rose-500 py-2 px-4 pe-10 shadow-sm sm:text-sm focus:outline-none focus:ring-slate-400 focus:border-slate-400" />
                ...
                <section aria-labelledby="products-heading" class="pt-6 pb-24">
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                        ...
                        <!-- Product grid -->
                        <div class="lg:col-span-3 container w-full">
                            <!-- Replace with your content -->
                            <div
                                class=" h-96 w-full rounded-lg px-4 border-4 border-dashed border-gray-200 lg:h-full lg:w-[60rem]">
                                <div id="productsContainer" class=" grid grid-cols-3 gap-7 py-10">
                                    @foreach ($products as $product)
                                        ...
                                        <div
                                            class="relative text-gray-700 w-72 min-h-[10rem] border border-gray-200  rounded-lg overflow-hidden">
                                            <img class="w-full h-56 object-cover"
                                                src="{{ asset('storage/' . $firstImage) }}" alt="">
                                            ...
                                            <div class="p-5 flex flex-col gap-3">
                                                ...
                                                <div class="mt-5 flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        <img class="opacity-50 " src="{{ asset('img/love.svg') }}"
                                                            alt="">
                                                    </button>
                                                    <a href="{{ route('overview', $product->id) }}"
                                                        class="flex-grow flex items-center justify-center bg-gray-300/60 hover:bg-gray-300/80 transition rounded-md ">
                                                        <img class="opacity-50 " src="{{ asset('img/eye.svg') }}"
                                                            alt="">
                                                    </a>
                                                </div>
