            ...
            <div class="bg-white">
                <div class="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 p-7 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        <a href="#" class="text-sm font-medium text-slate-900 hover:text-rose-500">Sign up</a>
                        <span class="text-lg font-medium text-slate-900 hover:text-rose-500 px-1">/</span>
                        <a href="#" class="text-sm font-medium text-slate-900 hover:text-rose-500">Log in</a>
                    </div>
                </div>
            </div>
