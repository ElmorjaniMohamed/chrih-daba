...
<body class="bg-slate-50 container">
        ...
        <div class="p-3 text-center sm:p-7">
            <p class="text-sm font-roboto uppercase tracking-widest text-red-600">
                Ooops!
            </p>

            <h2 class="mt-6 text-3xl font-semibold font-roboto">Désolé , votre paiement est refusé !</h2>

            <a
            class="mt-8 inline-block w-64 rounded-full bg-red-600 py-4 text-sm font-roboto text-white shadow-xl"
